...
public class MainCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Dish[] maincourses = {
                ...
                new Dish("black pepper", "Hot vindaloo made iwth hot black pepper and fresh chick pea", 1399),
                new Dish("goji berry and cauliflower", "A crisp salad featuring goji berry and cauliflower", 1499),
