...
public class StartersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dish[] dishes = {
                new Dish("mushroom and tofu", "mushroom with smoked tofu", 999),
                new Dish("egg and avocado uramaki", "boiled egges with fresh avacoda and rice", 1998),
                new Dish("Melon and lemon soup", "Fresh melon and lemon combined into creamy soup", 119),
